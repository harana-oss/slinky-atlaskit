package com.harana.slinky.atlaskit.field_text_stateless
...
@JSImport("@atlaskit/field-text", "FieldTextStateless")
@js.native
object ReactFieldTextStateless extends js.Object

@react object FieldTextStateless extends ExternalComponent {
  ...
  override val component = ReactFieldTextStateless
}